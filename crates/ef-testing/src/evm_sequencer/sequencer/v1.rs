...
use crate::evm_sequencer::{
    constants::{
        ...
        {
            EOA_CLASS, EOA_CLASS_HASH, GENERIC_ACCOUNT_CLASS, GENERIC_ACCOUNT_CLASS_HASH,
    ...
    pub static ref INITIAL_SEQUENCER_STATE: SequencerState = {
        ...
        (&mut state).set_contract_class(
            *CONTRACT_ACCOUNT_CLASS_HASH,
            convert_contract_class_v1(&GENERIC_ACCOUNT_CLASS).expect("Failed to convert CONTRACT ACCOUNT CLASS to contract class"),
